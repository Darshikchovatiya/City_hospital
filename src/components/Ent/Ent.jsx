...
import deimg1 from '../../assets/images/departments-1.jpg'
import deimg2 from '../../assets/images/departments-2.jpg'
import deimg3 from '../../assets/images/departments-3.jpg'
import deimg4 from '../../assets/images/departments-4.jpg'
import deimg5 from '../../assets/images/departments-5.jpg'
          ...
          <div className="tab-content">
            <div className="tab-pane active show" id="tab-1">
              <div className="row">
                ...
                <div className="col-lg-4 text-center order-1 order-lg-2">
                  <img src={deimg1} alt="ent" className="img-fluid"/>
                </div>
              </div>
            </div>
            <div className="tab-pane" id="tab-2">
              <div className="row">
                ...
                <div className="col-lg-4 text-center order-1 order-lg-2">
                  <img src={deimg2} alt="" className="img-fluid"/>
                </div>
              </div>
            </div>
            <div className="tab-pane" id="tab-3">
              <div className="row">
                ...
                <div className="col-lg-4 text-center order-1 order-lg-2">
                  <img src={deimg3} alt="" className="img-fluid"/>
                </div>
              </div>
            </div>
            <div className="tab-pane" id="tab-4">
              <div className="row">
                ...
                <div className="col-lg-4 text-center order-1 order-lg-2">
                  <img src={deimg4} alt="" className="img-fluid"/>
                </div>
              </div>
            </div>
            <div className="tab-pane" id="tab-5">
              <div className="row">
                ...
                <div className="col-lg-4 text-center order-1 order-lg-2">
                  <img src={deimg5} alt="" className="img-fluid"/>
                </div>
              </div>
            </div>
          </div>
